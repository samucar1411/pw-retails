...
const formSchema = z.object({
  legal_names: z.string().min(2, "Los nombres deben tener al menos 2 caracteres"),
  legal_last_names: z.string().min(2, "Los apellidos deben tener al menos 2 caracteres"),
  legal_identification_number: z.string().min(5, "El número de documento debe tener al menos 5 caracteres"),
})
...
export function LegalRepForm({ defaultValues, onSubmit, onBack }: LegalRepFormProps) {
  const form = useForm<z.infer<typeof formSchema>>({
    resolver: zodResolver(formSchema),
    defaultValues: {
      legal_names: defaultValues.legal_names || "",
      legal_last_names: defaultValues.legal_last_names || "",
      legal_identification_number: defaultValues.legal_identification_number || "",
    }
  })
