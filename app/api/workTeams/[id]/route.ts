...
export async function GET(
  ...
  try {
    const id = params.id;
    const API_URL = `https://sys.adminpy.com:18001/api/workTeams/${id}/`;
    
    console.log(`Proxying request to specific workTeams: ${API_URL}`);
    ...
    console.error("Error in workTeams API route:", error);
    return NextResponse.json(
