...
export async function GET(
  ...
  try {
    const id = params.id;
    const API_URL = `https://sys.adminpy.com:18001/api/sections/${id}/`;
    
    console.log(`Proxying request to specific sections: ${API_URL}`);
    ...
    console.error("Error in sections API route:", error);
    return NextResponse.json(
