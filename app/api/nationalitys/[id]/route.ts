...
export async function GET(
  ...
  try {
    const id = params.id;
    const API_URL = `https://sys.adminpy.com:18001/api/nationalitys/${id}/`;
    
    console.log(`Proxying request to specific nationalitys: ${API_URL}`);
    ...
    console.error("Error in nationalitys API route:", error);
    return NextResponse.json(
