...
export async function GET(
  ...
  try {
    const id = params.id;
    const API_URL = `https://sys.adminpy.com:18001/api/videoManagers/${id}/`;
    
    console.log(`Proxying request to specific videoManagers: ${API_URL}`);
    ...
    console.error("Error in videoManagers API route:", error);
    return NextResponse.json(
